...
if __name__ == "__main__":
    ...
    print("----------------------------------------prepare_data--------------------")
    data_prep.prepare_data(model_type=model_type)

    ############################### Model Definition ###############################
    print("--------------------MODEL DEFINITION--------------------")

    print("----------------------------------------SignalBackgroundClassifier--------------------")
    if model_type in ["BDT", "Neural_Network", "Random_Forest", "SVT", "kNN", "GNN"]:
...
# It is necessary to create the output file required for the Metrics module (li scrive nel file .txt di evaluation results)
...
if model_type=="GNN":
    save_file = os.path.join(output_folder, "Convolutional_GNN.keras")
